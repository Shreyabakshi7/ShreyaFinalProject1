...
import com.example.anurag_pc.shreyafinalproject.controller.controller;
...
public class FirstScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayout lm = (LinearLayout) findViewById(R.id.ll_first);
        final Button first_bt = (Button) findViewById(R.id.bt_first);
